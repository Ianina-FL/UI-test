module.exports = {
  ...
  async down(queryInterface, Sequelize) {
    ...
    try {
      ...
      await queryInterface.removeColumn('venues', 'features', { transaction });
      ...
      await queryInterface.removeColumn('vendors', 'service_type', {
        transaction,
      });
      ...
      await queryInterface.removeColumn('schedules', 'venueId', {
        transaction,
      });
      ...
      await queryInterface.removeColumn('schedules', 'title', { transaction });

      await queryInterface.removeColumn('guests', 'meal_preference', {
        transaction,
      });

      await queryInterface.removeColumn('guests', 'is_attending', {
        transaction,
      });

      await queryInterface.removeColumn('guests', 'email', { transaction });

      await queryInterface.removeColumn('guests', 'name', { transaction });

      await queryInterface.removeColumn('budgets', 'eventId', { transaction });

      await queryInterface.removeColumn('budgets', 'amount', { transaction });

      await queryInterface.removeColumn('budgets', 'name', { transaction });
